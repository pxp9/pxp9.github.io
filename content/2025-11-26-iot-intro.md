...
If you are in this article is because you are either interested on learning embedded systems, or how
...
- Micro processors units (MPU) devices like Raspberry Pi family, Beagle Bone or
  Arduino UNO Q (Arduino UNO Q is a exception board because it has a MPU and
...
Peripherials or Sensors are outside for MPUs, therefore, you will need to implement a driver
for this, or take one already done. Peripherials or sensors can be
...
and you might want help from smarter or with more experience people  than you.
